...
public class ChatClientGUI extends JFrame {
    ...
    public ChatClientGUI() {
        ...
        exitButton.addActionListener(e -> {
            String departureMessage = name + "Saiu do chat.";
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "OPS! Ocorreu um erro de conexão com o servidor", "Erro de conexão", JOptionPane.ERROR_MESSAGE);
